...
// -*- coding: utf-8 -*-
/* query_gangnam.php
 *	search book from 강남구전자 library
 * Input:
 ...
 */
/*
 * search URL: /book/book_information.asp
...
if (strpos($http_response_header[0], "200") == FALSE) { 
  ...
  $pos1 = strpos($html, "<!-- main_content_start  -->");
  $pos2 = strpos($html, "<!--main_content_end-->");
  $html2 = substr($html, $pos1, $pos2-$pos1);
  $html2 = str_replace('="/', '="'.$home_url."/", $html2);
  //echo $html2;

  include "parse_gangnam.php";
  $dom = parse_gangnam($html2);
}
